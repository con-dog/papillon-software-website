              ...
              {isHoveredMobileView && (
                <div className="absolute inset-0 bg-black bg-opacity-95 flex justify-center items-center text-white p-4">
                  <p className="text-wrap whitespace-pre-wrap text-sans">
                    ...
                    synchronised scrolling and navigation lets you test
                    seamlessly across any website.
                  </p>
                </div>
              )}
            </div>
          ...
          >
            ...
            >
              ...
              {isHoveredUICopilot && (
                <div className="absolute inset-0 bg-black bg-opacity-95 flex justify-center items-center text-white p-4">
                  <p className="text-wrap whitespace-pre-wrap text-sans">
                    This extension will automatically give you component level
                    and project level design feedback while you code! You set
                    the style, and work as normal
                  </p>
                </div>
              )}
            </div>
